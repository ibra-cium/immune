...
| — | 2026-08-30 | Done | Enforced mobile horizontal/landscape mode via orientation lock guard; overhauled horizontal HUD to ultra-minimal non-overlapping bio-capsule (<36px height) with docked top-center host monitor. |
